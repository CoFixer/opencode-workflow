---
skill_name: response-dto-factory
applies_to_local_project_only: false
auto_trigger_regex: [response dto, response wrapper, success response, created response, paginated response]
tags: [nestjs, dto, response, wrapper, swagger]
related_skills: [crud-module-generator, swagger-doc-generator]
---
