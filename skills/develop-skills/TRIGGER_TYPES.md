...
Complete reference for configuring skill triggers in OpenCode's skill auto-activation system.
...
```bash
cat <<'EOF' | npx tsx .opencode/hooks/skill-verification-guard.ts
{
  "session_id": "test",
  "tool_name": "Edit",
