---
name: generate-ppt
description: Generate HTML presentations with reveal.js and brand-consistent slide design
---
...
3. **Manrope headings + Inter body** - Consistent typography
...
- **Command**: `.opencode/base/commands/generate-ppt.md`
- **Template**: `.opencode/base/templates/reveal-townhall.html`
