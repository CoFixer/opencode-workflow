...
|-------------|---------------|
| API Implementation | `.opencode/base/templates/OpenCode-project/status/backend/API_IMPLEMENTATION_STATUS.template.md` |
| Screen Implementation | `.opencode/base/templates/OpenCode-project/status/frontend/SCREEN_IMPLEMENTATION_STATUS.template.md` |
| API Integration | `.opencode/base/templates/OpenCode-project/status/frontend/API_INTEGRATION_STATUS.template.md` |
| E2E QA Status | `.opencode/base/templates/OpenCode-project/status/frontend/E2E_QA_STATUS.template.md` |
