...
**Note**: opencode.md is processed last as it aggregates from other docs.
...
- Scan .opencode/commands/ for actual commands
...
- [ ] Verify opencode.md links work correctly
```
