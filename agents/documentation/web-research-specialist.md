...
This agent does not typically invoke other agents, as research is its sole focus.

## Delegation Guidelines

**Delegate when:** Never (research agent works independently)
**Do NOT delegate:** All tasks (core responsibility is pure research)
