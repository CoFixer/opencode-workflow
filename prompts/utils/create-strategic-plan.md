...
5. **Create task management structure**:
    - Determine the appropriate output location based on task type:
        ...
        - **OpenCode config changes** → `.opencode/base/plans/[task-name]/` or relevant submodule
...
- Consult `.opencode/docs/BEST_PRACTICES.md` for coding standards (if exists)
- Reference `.opencode/docs/TROUBLESHOOTING.md` for common issues to avoid (if exists)
