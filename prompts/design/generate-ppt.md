...
> Logo SVG source: `.opencode/base/brand/logo.svg` (when available). Inline SVG below is the embedded copy.
...
<head>
  ...
  <style>
    ...
    .reveal { font-family: 'Pretendard', 'Inter', sans-serif; }
    .reveal h1, .reveal h2, .reveal h3 { font-family: 'Manrope', 'Inter', sans-serif; color: var(--heading); font-weight: 600; }
    ...
    .title-slide .meta { color: var(--muted); font-size: 0.9em; margin-top: 2em; }
  </style>
</head>
<body>
  <div class="reveal">
